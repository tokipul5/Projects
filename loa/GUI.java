...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Setting->White Auto Black Auto", this::bothAuto);
        addMenuButton("Setting->White Manual Black Auto",
                this::whiteManBlackAuto);
        addMenuButton("Setting->White Auto Black Manual",
                this::whiteAutoBlackMan);
        addMenuButton("Setting->White Manual Black Manual", this::bothManual);
        addMenuButton("Other->About", (s) -> displayText("About", ABOUT_TEXT));
        addMenuButton("Other->Help", (s) -> displayText("Help", HELP_TEXT));
    ...
    private void bothAuto(String dummy) {
        _pendingCommands.offer("AA");
    }

    /** Response to "White Manual" button click. */
    private void whiteManBlackAuto(String dummy) {
        _pendingCommands.offer("MA");
    }

    /** Response to "Black Auto" button click. */
    private void whiteAutoBlackMan(String dummy) {
        _pendingCommands.offer("AM");
    }

    /** Response to "Black Manual" button click. */
    private void bothManual(String dummy) {
        _pendingCommands.offer("MM");
    }
